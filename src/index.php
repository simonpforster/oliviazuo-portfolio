...
<head>
    ...
    <link rel="stylesheet" href="./resources/styles/heading.css">
    ...
    <div class="column-container">
        <div class="pure-g">
            ...
            <div class="normal-1-6">
                ...
                <figure>
                    <img
                            path="/personal/2023/invisible-feast/3-desert.png"
                            fix="width">
                    <img
            ...
            <div class="normal-1-6">
                ...
                <figure>
                    <img
                            path="/commercial/budweiser/unmet-gala/invitation.jpg"
                            fix="width">
